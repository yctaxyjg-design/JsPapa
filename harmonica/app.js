...
/* =========================================================
   트레몰로(복음) 하모니카 24공 C키 — 삼익 STH-24 등 전통 복음 튜닝.
   24 물리 구멍 = 12 음 위치(각 위치가 트레몰로로 2겹).
   불기(날숨 ▲) = 도·미·솔(C·E·G),  들숨(▼) = 레·파·라·시(D·F·A·B).
   저음부(1~3번)는 파(F)·라(A)가 없고 들숨이 도음계 딸림화음(레·솔·시)으로 배열됩니다.
   ========================================================= */
...
const POSITIONS = [
  ...
  { hole: 11, blow: ["E", 7], draw: ["B", 6] },
  { hole: 12, blow: ["G", 7], draw: ["D", 7] },
];
...
/* ----------------------- 3) 음계 · 동요 ----------------------- */
// 'rest' = 쉼표. 음은 [이름, 옥타브].
// 동요·음계는 빈 음 없는 중간 옥타브(5옥타브)에서 연주합니다.
const R = "rest";
const SONGS = {
  "C장조 음계 (1옥타브)": [
  ...
  "학교종": [
    ["G", 5], ["G", 5], ["A", 5], ["A", 5], ["G", 5], ["G", 5], ["E", 5], R,
    ["G", 5], ["G", 5], ["E", 5], ["E", 5], ["D", 5], R,
    ["G", 5], ["G", 5], ["A", 5], ["A", 5], ["G", 5], ["G", 5], ["E", 5], R,
    ["G", 5], ["E", 5], ["D", 5], ["E", 5], ["C", 5],
  ],
  "반짝반짝 작은별": [
    ["C", 5], ["C", 5], ["G", 5], ["G", 5], ["A", 5], ["A", 5], ["G", 5], R,
    ["F", 5], ["F", 5], ["E", 5], ["E", 5], ["D", 5], ["D", 5], ["C", 5], R,
    ["G", 5], ["G", 5], ["F", 5], ["F", 5], ["E", 5], ["E", 5], ["D", 5], R,
    ["G", 5], ["G", 5], ["F", 5], ["F", 5], ["E", 5], ["E", 5], ["D", 5], R,
    ["C", 5], ["C", 5], ["G", 5], ["G", 5], ["A", 5], ["A", 5], ["G", 5], R,
    ["F", 5], ["F", 5], ["E", 5], ["E", 5], ["D", 5], ["D", 5], ["C", 5],
  ],
  "비행기": [
    ["E", 5], ["D", 5], ["C", 5], ["D", 5], ["E", 5], ["E", 5], ["E", 5], R,
    ["D", 5], ["D", 5], ["D", 5], R,
    ["E", 5], ["G", 5], ["G", 5], R,
    ["E", 5], ["D", 5], ["C", 5], ["D", 5], ["E", 5], ["E", 5], ["E", 5], R,
    ["D", 5], ["D", 5], ["E", 5], ["D", 5], ["C", 5],
