...
EMBEDDED_CORPUS = {
  ...
  "standards": [
    ...
    { "no": "1012", "ifrs": "IAS 12", "title": "법인세", "category": "부채·비용", "summary": "당기법인세와 이연법인세의 회계처리를 규정한다. 일시적차이에 따른 이연법인세자산·부채의 인식과 측정, 이연법인세자산의 실현가능성, 표시와 공시를 다룬다.", "keywords": ["법인세", "이연법인세", "일시적차이", "이연법인세자산", "이연법인세부채", "실현가능성", "당기법인세"] },
    ...
    { "no": "1019", "ifrs": "IAS 19", "title": "종업원급여", "category": "부채·비용", "summary": "단기종업원급여, 퇴직급여(확정기여제도·확정급여제도), 기타장기종업원급여, 해고급여의 회계처리를 규정한다. 확정급여채무의 측정, 보험수리적손익, 순확정급여부채를 다룬다.", "keywords": ["종업원급여", "퇴직급여", "확정급여제도", "확정기여제도", "보험수리적손익", "순확정급여부채", "해고급여"] },
    ...
    { "no": "1109", "ifrs": "IFRS 9", "title": "금융상품", "category": "금융상품", "summary": "금융자산·금융부채의 분류와 측정, 기대신용손실에 따른 손상, 위험회피회계를 규정한다. 상각후원가·FVOCI·FVPL 분류, 12개월·전체기간 기대신용손실을 다룬다.", "keywords": ["금융상품", "금융자산 분류", "상각후원가", "FVOCI", "FVPL", "기대신용손실", "손상", "위험회피회계"] },
    ...
    { "no": "1115", "ifrs": "IFRS 15", "title": "고객과의 계약에서 생기는 수익", "category": "수익", "summary": "고객과의 계약에서 생기는 수익의 인식을 규정한다. 5단계 모형(계약 식별, 수행의무 식별, 거래가격 산정, 거래가격 배분, 수행의무 이행 시 수익인식)을 다룬다.", "keywords": ["수익인식", "5단계 모형", "수행의무", "거래가격", "계약", "변동대가", "한 시점·기간에 걸쳐 인식"] },
    { "no": "1116", "ifrs": "IFRS 16", "title": "리스", "category": "자산", "summary": "리스의 인식·측정·표시·공시를 규정한다. 리스이용자는 사용권자산과 리스부채를 인식하고, 리스제공자는 금융리스·운용리스로 분류한다. 단기·소액 리스 면제를 다룬다.", "keywords": ["리스", "사용권자산", "리스부채", "리스이용자", "리스제공자", "금융리스", "운용리스", "단기리스"] },
